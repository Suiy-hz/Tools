...
public enum BankNameEnum {
     ...
     */
    ICBC("102", "中国工商银行", "工商银行", new Integer[]{622200, 955880},
     ...
     */
    ABC("103", "中国农业银行", "农业银行", new Integer[]{622848, 622841}, new Integer[]{622836,622837}),
     ...
     */
    BOC("104", "中国银行", "中国银行", new Integer[]{622760, 621790}, new Integer[]{622453}),
     ...
     * 交通银行太平洋卡借记卡：622260
     */
    BCM("301", "交通银行", "交通银行", new Integer[]{622260, 405512}, new Integer[]{620021}),
     ...
     */
    CMBC("305", "中国民生银行", "民生银行", new Integer[]{622615}, new Integer[]{545392}),
     ...
     * 广发真情卡：548844
     */
    GDB("306", "广东发展银行", "广发银行", new Integer[]{622568}, new Integer[]{406365}),
     ...
     * 深圳发展银行发展卡借记卡：622538
     */
    PAB("307", "平安银行", "平安银行", new Integer[]{412963}, new Integer[]{620010}),
     ...
     */
    CMB("308", "招商银行", "招商银行", new Integer[]{402658, 621485}, new Integer[]{356885}),

    /**
     * 兴业银行
     * 兴业银行：451289、622902、622901、527414、524070、486493、486494、451290、523036、486861、622922
     */
    CIB("309", "兴业银行", "兴业银行", new Integer[]{622901, 622902}, new Integer[]{461982}),
     ...
     */
    SPDB("310", "上海浦东发展银行", "浦发银行", new Integer[]{622521, 622516}, new Integer[]{356851}),
     ...
     * </pre>
     */
    PSBC("403", "中国邮政储蓄银行", "邮政储蓄", new Integer[]{622188, 621096}, new Integer[]{620529});
